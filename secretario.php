		...
		<div class="container">
			<div class="row d-flex justify-content-center align-items-center">
				<div class="col-sm-12 secretario-content d-flex justify-content-center align-items-start flex-wrap p-0 m-0">
					<div class="col-sm-5 py-0 px-3 mx-0 mt-5 mb-5 d-flex flex-column secretario-item" style="margin-right: 40px !important;">
					...
					<div class="col-sm-5 py-0 px-3 mx-0 mt-5 mb-5 d-flex flex-column secretario-item">
