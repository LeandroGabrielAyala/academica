	...
	<section id="secretario">
		<div class="container">
			<div class="row d-flex flex-column justify-content-center align-items-center">
				<img alt="Secretario Académico" class="perfil mt-4" src="https://picsum.photos/id/237/200/200"></img>
			...
			<div class="row d-flex justify-content-center align-items-center">
				<div class="col-sm-12 secretario-content d-flex justify-content-center align-items-start flex-wrap p-0 m-0">
					<div class="col-sm-10 py-0 px-3 mx-0 mt-2 mb-5 d-flex flex-column secretario-item">
